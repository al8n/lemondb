use crate::types::{fid::Fid, log_extension::LogExtension};

const MAX_DIGITS: usize = 20; // u64::MAX has 20 digits

// 20 digits + 1 dot + 4 extension
const MAX_FILENAME_SUFFIX_LEN: usize = LogExtension::LEN + MAX_DIGITS + 1;
...
pub fn filename<P>(dir: P, fid: Fid, ext: LogExtension) -> std::path::PathBuf
where
